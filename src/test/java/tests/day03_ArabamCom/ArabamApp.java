...
public class ArabamApp {
    ...
    @Test
    public void arabamTest1() throws InterruptedException, IOException {
        ...
        action.press(PointOption.point(521,1809))
                ...
                .waitAction(WaitOptions.waitOptions(Duration.ofMillis(85)))
       ...
       //screenshot alma
        ...
        FileUtils.copyFile(ekranfotografi,new File("t142.png"));
    //screenshitalma
